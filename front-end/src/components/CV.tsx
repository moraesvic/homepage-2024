...
const CV = (t: CVProps) => {
  return (
    <div className="w-full bg-black p-1 md:p-2 text-white grid place-items-center">
      <div
      ...
      >
        ...
        <div className="row-span-2 flex items-center justify-start gap-2 md:justify-between md:gap-0 flex-wrap">
          ...
          >
            <div className="flex gap-2 items-center text-center mb-2">
              <GitHubIcon fill="white" bgColor="black" size={26} />
              <div>@moraesvic</div>
            </div>
          </a>
          <a
          ...
          >
            <div className="flex gap-2 items-center text-center mb-2">
              <EmailIcon fill="white" bgColor="black" size={26} />
